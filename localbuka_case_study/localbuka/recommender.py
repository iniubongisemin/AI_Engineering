...
class Recommender:
    ...
    def _validate(self, preferences, limit):
        ...
        if preferences.spice_preference and preferences.spice_preference not in VALID_SPICE_LEVELS:
            raise ValueError("spice_preference must be mild, medium, or hot")
